...
export default function Settings() {
  ...
  return (
    <div className="p-4 pt-2 md:p-12 max-w-4xl mx-auto pb-28 md:pb-20 page-ambient" style={{ color: 'var(--text-primary)', '--ambient-x': '30%', '--ambient-y': '5%', '--ambient-opacity': '0.035' }}>
        ...
        <section className="glass-panel glass-shine rounded-2xl p-6">
          ...
          <button onClick={async () => {
            if (installPrompt) {
              ...
              alert("App installation is not available. It might already be installed, or your browser may not support it.");
            }
          }}
